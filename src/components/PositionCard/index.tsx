...
import { Button, Card as UIKitCard, CardBody, Text } from 'kebabfinance-uikit'
        ...
        <UIKitCard>
          <StyledCardBody>
            <AutoColumn gap="18px">
              <FixedHeightRow>
                <RowFixed>
                  <Text bold>LP TOKENS IN YOUR WALLET</Text>
                </RowFixed>
              </FixedHeightRow>
              ...
              <AutoColumn gap="4px">
                <FixedHeightRow>
                  ...
                  {token0Deposited ? (
                    <RowFixed>
                      <Text bold>{token0Deposited?.toSignificant(6)}</Text>
                    </RowFixed>
                  ) : (
                    '-'
                  )}
                ...
                <FixedHeightRow>
                  ...
                  {token1Deposited ? (
                    <RowFixed>
                      <Text bold>{token1Deposited?.toSignificant(6)}</Text>
                    </RowFixed>
                  ) : (
                    '-'
                  )}
